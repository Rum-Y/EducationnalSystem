...
public interface CourseService {
    ...
    //获取分页查询课程信息
    PageInfo<CourseCustom> findByKeyWord(String keyWord,Integer pageNum,Integer pageSize) throws Exception;
    ...
    //根据教师id查找课程
	PageInfo<Course> findByTeacherID(String keyWord,Integer pageNum,Integer pageSize,Integer id) throws Exception;
}
